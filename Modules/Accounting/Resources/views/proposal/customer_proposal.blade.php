@php
    // $logo=asset(Storage::url('uploads/logo/'));
     ...
     $company_setting=\Modules\Accounting\Models\Utility::settingsById($proposal->created_by);
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('new_assets/css/plugins/main.css') }}">
    <link rel="stylesheet" href="{{ asset('new_assets/css/plugins/style.css') }}">
    <link rel="stylesheet" href="{{ asset('new_assets/css/plugins/animate.min.css') }}">

    <!-- font css -->
    <link rel="stylesheet" href="{{ asset('new_assets/fonts/tabler-icons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('new_assets/fonts/feather.css') }}">
    <link rel="stylesheet" href="{{ asset('new_assets/fonts/fontawesome.css') }}">
    <link rel="stylesheet" href="{{ asset('new_assets/fonts/material.css') }}">

    <!-- vendor css -->
    <link rel="stylesheet" href="{{ asset('new_assets/css/style.css') }}" id="main-style-link">
    <link rel="stylesheet" href="{{ asset('new_assets/css/customizer.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom.css') }}" id="main-style-link">
    <link rel="stylesheet" href="{{ asset('new_assets/css/plugins/bootstrap-switch-button.min.css') }}">
                                ...
                                <div class="col">
                                    <small>
                                        ...
                                        @if($proposal->status == 0)
                                            <span class="badge badge-pill badge-primary">{{ __(\Modules\Accounting\Models\Proposal::$statues[$proposal->status]) }}</span>
                                        @elseif($proposal->status == 1)
                                            <span class="badge badge-pill badge-info">{{ __(\Modules\Accounting\Models\Proposal::$statues[$proposal->status]) }}</span>
                                        @elseif($proposal->status == 2)
                                            <span class="badge badge-pill badge-success">{{ __(\Modules\Accounting\Models\Proposal::$statues[$proposal->status]) }}</span>
                                        @elseif($proposal->status == 3)
                                            <span class="badge badge-pill badge-warning">{{ __(\Modules\Accounting\Models\Proposal::$statues[$proposal->status]) }}</span>
                                        @elseif($proposal->status == 4)
                                            <span class="badge badge-pill badge-danger">{{ __(\Modules\Accounting\Models\Proposal::$statues[$proposal->status]) }}</span>
                                        @endif
                                    </small>
                                </div>
...
<script src="{{ asset('new_assets/js/plugins/popper.min.js') }}"></script>
<script src="{{ asset('new_assets/js/plugins/perfect-scrollbar.min.js') }}"></script>
<script src="{{ asset('new_assets/js/plugins/bootstrap.min.js') }}"></script>
<script src="{{ asset('new_assets/js/plugins/feather.min.js') }}"></script>
<script src="{{ asset('new_assets/js/dash.js') }}"></script>

<script src="{{ asset('new_assets/js/plugins/bootstrap-switch-button.min.js') }}"></script>

<script src="{{ asset('new_assets/js/plugins/sweetalert2.all.min.js') }}"></script>
<script src="{{ asset('new_assets/js/plugins/simple-datatables.js') }}"></script>

<!-- Apex Chart -->
<script src="{{ asset('new_assets/js/plugins/apexcharts.min.js') }}"></script>
<script src="{{ asset('new_assets/js/plugins/main.min.js') }}"></script>
<script src="{{ asset('new_assets/js/plugins/choices.min.js') }}"></script>
