                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (invoiceItems != null) {
                                ...
                                $(el.parent().parent().parent().parent().find('.pro_description')).val(invoiceItems.description);
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            <span><i class="fa fa-joint"></i></span>
                                ...
                                @if(!$customFields->isEmpty())
                                    <div class="col-md-6">
                                        <div class="tab-pane fade show" id="tab-2" role="tabpanel">
                                            @include('accounting::customFields.formBuilder')
                                        </div>
                                    </div>
                                @endif
                            </div>
...
{{--                                        <a href="#" class="fa fa-trash text-white text-danger delete_item" data-repeater-delete></a>--}}
{{--                                    @endcan--}}

                                        <a href="#" class="fa fa-trash text-white repeater-action-btn bg-danger ms-2  delete_item" data-repeater-delete></a>
