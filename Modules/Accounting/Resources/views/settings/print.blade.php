                                        ...
                                        <form id="setting-form" method="post" action="{{route('proposal.template.setting')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="proposal_template">
                                                    @foreach(\Modules\Accounting\Models\Utility::templateData()['templates'] as $key => $template)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row gutters-xs">
                                                    @foreach(\Modules\Accounting\Models\Utility::templateData()['colors'] as $key => $color)
                                                        <div class="col-auto">
