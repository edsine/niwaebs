@php
   ...
   $logo=\Modules\Accounting\Models\Utility::get_file('uploads/logo');
    ...
    $company_setting=\Modules\Accounting\Models\Utility::settingsById($bill->created_by);
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <small>
                                        ...
                                        @if($bill->status == 0)
                                            <span class="badge bg-primary">{{ __(\Modules\Accounting\Models\Bill::$statues[$bill->status]) }}</span>
                                        @elseif($bill->status == 1)
                                            <span class="badge bg-warning">{{ __(\Modules\Accounting\Models\Bill::$statues[$bill->status]) }}</span>
                                        @elseif($bill->status == 2)
                                            <span class="badge bg-danger">{{ __(\Modules\Accounting\Models\Bill::$statues[$bill->status]) }}</span>
                                        @elseif($bill->status == 3)
                                            <span class="badge bg-info">{{ __(\Modules\Accounting\Models\Bill::$statues[$bill->status]) }}</span>
                                        @elseif($bill->status == 4)
                                            <span class="badge bg-success">{{ __(\Modules\Accounting\Models\Bill::$statues[$bill->status]) }}</span>
                                        @endif
                                    </small>
                                </div>
                                                ...
                                                @if(!empty($iteam->tax))
                                                    @php
                                                        ...
                                                        foreach($taxes as $taxe){
                                                            $taxDataPrice=\Modules\Accounting\Models\Utility::taxRate($taxe->rate,$iteam->price,$iteam->quantity);
                                                        ...
                                                        @if(!empty($iteam->tax))
                                                            <table>
                                                                ...
                                                                @foreach($taxes as $tax)
                                                                    @php
                                                                        $taxPrice=\Modules\Accounting\Models\Utility::taxRate($tax->rate,$iteam->price,$iteam->quantity);
