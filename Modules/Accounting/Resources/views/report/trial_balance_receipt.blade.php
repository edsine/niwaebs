...
<head>
    ...
    @if (isset($settings['SITE_RTL'] ) && $settings['SITE_RTL'] == 'on')
        <link rel="stylesheet" href="{{ asset('new_assets/assets/css/style-rtl.css')}}" id="main-style-link">
    @endif
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div
                        ...
                        <h6 class="mb-0">{{ _('Account Code') }}</h6>
                        <h6 class="mb-0">{{ __('Debit') }}</h6>
                        <h6 class="mb-0">{{ __('Credit') }}</h6>
                    ...
                    <div
                        ...
                        <h6 class="fw-bold mb-0">{{ $totalDebit }}</h6>
                        <h6 class="fw-bold mb-0">{{ $totalCredit }}</h6>
