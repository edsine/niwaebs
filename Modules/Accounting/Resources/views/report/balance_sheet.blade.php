...
<div class="col-md-12">
    <div class="float-end">
        ...
        <button type="submit" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="{{ __('Print') }}"
            data-original-title="{{ __('Print') }}"><i class="fa fa-print"></i></button>
        {{ Form::close() }}
    </div>
    ...
    <div class="float-end me-2">
        ...
        <button type="submit" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="{{ __('Export') }}"
            data-original-title="{{ __('Export') }}"><i class="fa fa-file-export"></i></button>
        {{ Form::close() }}
    </div>
    ...
    <div class="float-end me-2" id="filter">
        <button id="filter" class="btn btn-sm btn-primary"><i class="fa fa-filter"></i></button>
    </div>
</div>
</div>
    <div class="mt-4">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <a href="{{ route('report.balance.sheet') }}" class="btn btn-sm btn-danger "
                                                ...
                                                <span class="btn-inner--icon"><i
                                                        class="fa fa-trash-off text-white-off "></i></span>
                                            </a>
                                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="account-main-title mb-5">
                            <h5>{{ 'Balance Sheet of ' . $user->first_name . ' '. $user->last_name. ' as of ' . $filter['startDateRange'] . ' to ' . $filter['endDateRange'] }}
                                </h4>
                        </div>
                        <div
