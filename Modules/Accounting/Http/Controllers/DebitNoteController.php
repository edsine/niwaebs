...
class DebitNoteController extends AppBaseController
{
    ...
    public function create($bill_id)
    {
        if(Auth::user()->can('create debit note'))
        {
            ...
            return view('accounting::debitNote.create', compact('billDue', 'bill_id'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function edit($bill_id, $debitNote_id)
    {
        if(Auth::user()->can('edit debit note'))
        {
            ...
            return view('accounting::debitNote.edit', compact('debitNote'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
...
//            Utility::userBalance('vendor', $billDue->vender_id, $request->amount, 'debit');
    ...
    public function customCreate()
    {
        if(Auth::user()->can('create debit note'))
        {
            ...
            return view('accounting::debitNote.custom_create', compact('bills'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
