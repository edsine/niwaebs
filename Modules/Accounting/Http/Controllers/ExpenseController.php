...
use Modules\Accounting\Models\Project;
...
class ExpenseController extends AppBaseController
{
    ...
    public function employee(Request $request)
    {
        ...
        return view('accounting::expense.employee_detail', compact('employee'));
    }
    ...
    public function vender(Request $request)
    {
        ...
        return view('accounting::expense.vender_detail', compact('vender'));
    }
    public function customer(Request $request)
    {
        $customer = User::where('id', '=', $request->id)->first();
        return view('accounting::expense.customer_detail', compact('customer'));
    }
    ...
    public function index(Request $request)
    {
        ...
        if(Auth::user()->can('manage bill'))
        {
            ...
            return view('accounting::expense.index', compact('expenses', 'vender', 'status','category'));
        }
        else
        {
    ...
    public function create($Id)
    {
        if(Auth::user()->can('create bill'))
        {
            ...
            })->pluck('full_name', 'id')->prepend('Select Employee', '');
            ...
            return view('accounting::expense.create', compact('employees','customers','venders', 'expense_number', 'product_services', 'category', 'customFields', 'Id','chartAccounts','accounts'));
        }
        else
        {
    ...
    public function show($ids)
    {
        ...
        if(Auth::user()->can('show bill'))
        {
            ...
            if(!empty($expense) && $expense->created_by == Auth::user()->creatorId())
            {
                ...
                return view('accounting::expense.view', compact('expense', 'user', 'items', 'expensePayment'));
            }
            else
            {
                return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function edit($ids)
    {
        ...
        if(Auth::user()->can('edit bill'))
        {
            ...
            if(!empty($expense))
            {
                ...
                return view('accounting::expense.edit', compact('employees','customers','venders', 'product_services', 'expense', 'expense_number', 'category',
...
//                        'vender_id' => 'required',
    ...
    public function expense($expense_id)
    {
        ...
        $settings_data = Utility::settingsById($expense->created_by);
        ...
        if($expense)
        {
            ...
            return view('accounting::bill.templates.' . $settings['bill_template'], compact('expense', 'color', 'settings', 'vendor', 'img', 'font_color'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
