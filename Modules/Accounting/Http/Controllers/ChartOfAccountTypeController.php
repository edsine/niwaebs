...
class ChartOfAccountTypeController extends AppBaseController
{
    ...
    public function index()
    {
        ...
        { */
            ...
            return view('accounting::chartOfAccountType.index', compact('types'));
        /* }
        else
        {
    ...
    {
        return view('accounting::chartOfAccountType.create');
    }
    ...
    {
        return view('accounting::chartOfAccountType.edit', compact('chartOfAccountType'));
    }
