...
class ChartOfAccountController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        return view('accounting::chartOfAccount.create', compact('types'));
    }
    ...
    public function show(ChartOfAccount $chartOfAccount,Request $request)
    {
        ...
        { */
            ...
            return view('accounting::chartOfAccount.show', compact('filter', 'account', 'accounts' , 'journalItems'));
        /* }
        else
        {
            return redirect()->back()->with('error', __('Permission Denied.'));
    ...
    public function edit(ChartOfAccount $chartOfAccount)
    {
        ...
        return view('accounting::chartOfAccount.edit', compact('chartOfAccount', 'types'));
    }
