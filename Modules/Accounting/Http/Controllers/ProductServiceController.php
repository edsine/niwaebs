...
use Modules\Accounting\Exports\ProductServiceExport;
...
class ProductServiceController extends AppBaseController
{
    ...
    public function create()
    {
        if(Auth::user()->can('create product & service'))
        {
            ...
            return view('accounting::productservice.create', compact('category', 'unit', 'tax', 'customFields','incomeChartAccounts','expenseChartAccounts'));
        }
        else
        {
    ...
    public function edit($id)
    {
        ...
        if(Auth::user()->can('edit product & service'))
        {
            if($productService->created_by == Auth::user()->creatorId())
            {
                ...
                return view('accounting::productservice.edit', compact('category', 'unit', 'tax', 'productService', 'customFields','incomeChartAccounts','expenseChartAccounts'));
            }
            else
            {
                return response()->json(['error' => __('Permission denied.')], 401);
...
//                    $path = Utility::upload_file($request,'pro_image',$fileName,$dir,[]);
    ...
    {
        return view('accounting::productservice.import');
    }
    ...
    public function warehouseDetail($id)
    {
        ...
        return view('accounting::productservice.detail', compact('products'));
    }
