...
class BankTransferController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        { */
            ...
            return view('accounting::bank-transfer.create', compact('bankAccount'));
        /* }
        else
        {
    ...
    public function edit(BankTransfer $transfer,$id)
    {
        ...
        { */
            ...
            return view('accounting::bank-transfer.edit', compact('bankAccount', 'transfer'));
        /* }
        else
        {
            return response()->json(['error' => __('Permission denied.')], 401);
