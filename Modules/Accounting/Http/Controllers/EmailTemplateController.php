...
use Modules\Accounting\Models\EmailTemplateLang;
use Modules\Accounting\Models\Language;
use Modules\Accounting\Models\UserEmailTemplate;
...
class EmailTemplateController extends AppBaseController
{
    ...
    public function index()
    {
        ...
        if($usr->type == 'company')
        {
            ...
            return view('accounting::settings.company', compact('EmailTemplates'));
        }
        else
        {
...
//        {
            return view('accounting::email_templates.create');
//        }
//        else
//        {
//            return redirect()->back()->with('error', __('Permission denied.'));
