...
class Pos extends Model
{
    ...
    {
        return $this->hasOne('Modules\Accounting\Models\warehouse', 'id', 'warehouse_id');
    }

    public function posPayment()
    {
        return $this->hasOne('Modules\Accounting\Models\PosPayment','pos_id','id');
    }

    public function items()
    {
        return $this->hasMany('Modules\Accounting\Models\PosProduct', 'pos_id', 'id');
    }
