...
//        $toDate   = $to . '-01';
        ...
        if(\Modules\Accounting\Models\Goal::$goalType[$type] == 'Invoice')
        {
        ...
        elseif(\Modules\Accounting\Models\Goal::$goalType[$type] == 'Bill')
        {
        ...
        elseif(\Modules\Accounting\Models\Goal::$goalType[$type] == 'Revenue')
        {
        ...
        elseif(\Modules\Accounting\Models\Goal::$goalType[$type] == 'Payment')
        {
