...
class Purchase extends Model
{
    ...
    {
        return $this->hasMany('Modules\Accounting\Models\PurchaseProduct', 'purchase_id', 'id');
    }
    public function payments()
    {
        return $this->hasMany('Modules\Accounting\Models\PurchasePayment', 'purchase_id', 'id');
    }
    ...
    {
        return $this->hasOne('Modules\Accounting\Models\PurchasePayment', 'id', 'purchase_id');
    }
