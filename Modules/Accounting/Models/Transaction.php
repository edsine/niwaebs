...
class Transaction extends Model
{
    ...
    {
        return $this->hasOne('Modules\Accounting\Models\BankAccount', 'id', 'account')->first();
    }
    ...
    {
        return $this->hasOne('Modules\Accounting\Models\InvoicePayment', 'id', 'payment_id');
    }

    public function billPayment()
    {
        return $this->hasOne('Modules\Accounting\Models\BillPayment', 'id', 'payment_id');
    }
