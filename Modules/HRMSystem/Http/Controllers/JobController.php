...
class JobController extends AppBaseController
{
    ...
    public function index()
    {
        if(Auth::user()->can('manage job'))
        {
            ...
            return view('hrmsystem::job.index', compact('jobs', 'data'));
        }
        else
        {
    ...
    public function create()
    {
        ...
        return view('hrmsystem::job.create', compact('categories', 'status', 'branches', 'customQuestion'));
    }
    ...
    public function show(Job $job)
    {
        ...
        return view('hrmsystem::job.show', compact('status', 'job'));
    }
    ...
    public function edit(Job $job)
    {
        ...
        return view('hrmsystem::job.edit', compact('categories', 'status', 'branches', 'job', 'customQuestion'));
    }
    ...
    public function career($id, $lang)
    {
        ...
        return view('hrmsystem::job.career', compact('companySettings', 'jobs', 'languages', 'currantLang','id'));
    }
    ...
    public function jobRequirement($code, $lang)
    {
        ...
        return view('hrmsystem::job.requirement', compact('companySettings', 'job', 'languages', 'currantLang'));
    }
    ...
    public function jobApply($code, $lang)
    {
        ...
        return view('hrmsystem::job.apply', compact('companySettings', 'job', 'questions', 'languages', 'currantLang'));
    }
