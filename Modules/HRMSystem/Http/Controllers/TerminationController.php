...
use App\Models\User;
use Modules\HRMSystem\Models\Termination;
use Modules\HRMSystem\Models\TerminationType;
...
class TerminationController extends AppBaseController
{
    public function index()
    {
        if(Auth::user()->can('manage termination'))
        {
            ...
            return view('hrmsystem::termination.index', compact('terminations'));
        }
        else
        {
    ...
    public function create()
    {
        if(Auth::user()->can('create termination'))
        {
            ...
            return view('hrmsystem::termination.create', compact('employees', 'terminationtypes'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        if(Auth::user()->can('create termination'))
        {
            ...
            {
                $employee           = User::find($termination->employee_id);
...
//                $termination->email = $employee->email;
    ...
    public function edit(Termination $termination)
    {
        if(Auth::user()->can('edit termination'))
        {
            ...
            if($termination->created_by == Auth::user()->creatorId())
            {
                ...
                return view('hrmsystem::termination.edit', compact('termination', 'employees', 'terminationtypes'));
            }
            else
            {
                return response()->json(['error' => __('Permission denied.')], 401);
    ...
    public function description($id)
    {
        ...
        return view('hrmsystem::termination.description', compact('termination'));
    }
