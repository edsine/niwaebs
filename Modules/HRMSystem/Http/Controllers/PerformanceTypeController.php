...
class PerformanceTypeController extends AppBaseController
{
    ...
    public function index()
    {
        if(Auth::user()->can('manage performance type'))
        {
            ...
            { */
                ...
                return view('hrmsystem::performanceType.index', compact('types'));
            /* }
            else
            {
    ...
    {
        return view('hrmsystem::performanceType.create');
    }
    ...
    {
        return view('hrmsystem::performanceType.edit', compact('performanceType'));
    }
