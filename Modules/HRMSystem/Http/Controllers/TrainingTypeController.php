...
class TrainingTypeController extends AppBaseController
{
    ...
    public function index()
    {
        if(Auth::user()->can('manage training type'))
        {
            ...
            return view('hrmsystem::trainingtype.index', compact('trainingtypes'));
        }
        else
        {
    ...
    public function create()
    {
        ...
        {
            return view('hrmsystem::trainingtype.create');
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function edit($id)
    {
        ...
        if(Auth::user()->can('edit training type'))
        {
            ...
            if($trainingType->created_by == Auth::user()->creatorId())
            {
                ...
                return view('hrmsystem::trainingtype.edit', compact('trainingType'));
            }
            else
            {
                return redirect()->back()->with('error', __('Permission denied.'));
