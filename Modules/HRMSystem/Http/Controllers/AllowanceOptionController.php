...
class AllowanceOptionController extends AppBaseController
{
    public function index()
    {
        if(Auth::user()->can('manage allowance option'))
        {
            ...
            return view('hrmsystem::allowanceoption.index', compact('allowanceoptions'));
        }
        else
        {
    ...
    public function create()
    {
        ...
        {
            return view('hrmsystem::allowanceoption.create');
        }
        else
        {
    ...
    public function edit(AllowanceOption $allowanceoption)
    {
        if(Auth::user()->can('edit allowance option'))
        {
            if($allowanceoption->created_by == Auth::user()->creatorId())
            {
                ...
                return view('hrmsystem::allowanceoption.edit', compact('allowanceoption'));
            }
            else
            {
                return response()->json(['error' => __('Permission denied.')], 401);
