...
use App\Models\User;
//use Modules\HRMSystem\Models\Mail\PromotionSend;
use Modules\HRMSystem\Models\Promotion;
...
class PromotionController extends AppBaseController
{
    public function index()
    {
        if(Auth::user()->can('manage promotion'))
        {
            ...
            return view('hrmsystem::promotion.index', compact('promotions'));
        }
        else
        {
    ...
    public function create()
    {
        if(Auth::user()->can('create promotion'))
        {
            ...
            return view('hrmsystem::promotion.create', compact('employees', 'designations'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        if(Auth::user()->can('create promotion'))
        {
            ...
            {
                $employee               = User::find($promotion->employee_id);
    ...
    public function edit(Promotion $promotion)
    {
        ...
        if(Auth::user()->can('edit promotion'))
        {
            ...
            {
                return view('hrmsystem::promotion.edit', compact('promotion', 'employees', 'designations'));
            }
            else
            {
                return response()->json(['error' => __('Permission denied.')], 401);
