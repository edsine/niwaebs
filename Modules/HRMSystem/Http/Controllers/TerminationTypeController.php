...
class TerminationTypeController extends AppBaseController
{
    public function index()
    {
        if(Auth::user()->can('manage termination type'))
        {
            ...
            return view('hrmsystem::terminationtype.index', compact('terminationtypes'));
        }
        else
        {
    ...
    public function create()
    {
        ...
        {
            return view('hrmsystem::terminationtype.create');
        }
        else
        {
    ...
    public function edit(TerminationType $terminationtype)
    {
        if(Auth::user()->can('edit termination type'))
        {
            if($terminationtype->created_by == Auth::user()->creatorId())
            {
                ...
                return view('hrmsystem::terminationtype.edit', compact('terminationtype'));
            }
            else
            {
                return response()->json(['error' => __('Permission denied.')], 401);
