...
class JobApplicationController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if(Auth::user()->can('manage job application'))
        {
            ...
            return view('hrmsystem::jobApplication.index', compact('stages', 'jobs', 'filter'));
        }
        else
        {
    ...
    public function create()
    {
        ...
        return view('hrmsystem::jobApplication.create', compact('jobs', 'questions'));
    }
    ...
    public function show($ids)
    {
        ...
        if(Auth::user()->can('show job application'))
        {
            ...
            return view('hrmsystem::jobApplication.show', compact('jobApplication', 'notes', 'stages'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function candidate()
    {
        if(Auth::user()->can('manage job onBoard'))
        {
            ...
            return view('hrmsystem::jobApplication.candidate', compact('archive_application'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function jobBoardCreate($id)
    {
        ...
        return view('hrmsystem::jobApplication.onboardCreate', compact('id', 'status', 'applications','job_type','salary_type','salary_duration'));
    }
    ...
    public function jobOnBoard()
    {
        if(Auth::user()->can('manage job onBoard'))
        {
            ...
            return view('hrmsystem::jobApplication.onboard', compact('jobOnBoards'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function jobBoardEdit($id)
    {
        ...
        return view('hrmsystem::jobApplication.onboardEdit', compact('jobOnBoard', 'status','job_type','salary_type','salary_duration'));
    }
    ...
    public function jobBoardConvert($id)
    {
        ...
        return view('hrmsystem::jobApplication.convert', compact('jobOnBoard', 'employees', 'employeesId', 'departments', 'designations', 'documents', 'branches', 'company_settings'));
...
//                               'document.*' => 'mimes:jpeg,png,jpg,gif,svg,pdf,doc,zip|max:20480',
    ...
    public function offerletterPdf($id)
    {
        ...
        return view('hrmsystem::jobApplication.template.offerletterpdf', compact('Offerletter','name'));
    ...
    public function offerletterDoc($id)
    {
        ...
        $Offerletter->content = GenerateOfferLetter::replaceVariable($Offerletter->content, $obj);
        return view('hrmsystem::jobApplication.template.offerletterdocx', compact('Offerletter','name'));
