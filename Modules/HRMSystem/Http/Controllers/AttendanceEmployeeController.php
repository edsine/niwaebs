...
use Modules\HRMSystem\Imports\AttendanceImport;
...
class AttendanceEmployeeController extends AppBaseController
{
    public function index(Request $request)
    {
        ...
        if(Auth::user()->can('manage attendance'))
        {
           ...
           /*  } */
            ...
            return view('hrmsystem::attendance.index', compact('attendanceEmployee', 'branch', 'department'));
        }
        else
        {
    ...
    public function create()
    {
        if(Auth::user()->can('create attendance'))
        {
            ...
            return view('hrmsystem::attendance.create', compact('employees'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function edit($id)
    {
        if(Auth::user()->can('edit attendance'))
        {
            ...
            return view('hrmsystem::attendance.edit', compact('attendanceEmployee', 'employees'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
       ...
       /*  if ($settings['ip_restrict'] == 'on') {
        ...
        if(empty($todayAttendance))
        {
            ...
            if(empty($checkDb))
            {
                ...
                return redirect()->route('attendanceemployee')->with('success', __('Employee Successfully Clock In.'));
            }
    ...
    public function bulkAttendance(Request $request)
    {
        if(Auth::user()->can('create attendance'))
        {
            ...
            {
                $employees = User::where('created_by', Auth::user()->creatorId())->where('branch_id', $request->branch)->where('department_id', $request->department)->get();


            }else{
                $employees = User::where('created_by', Auth::user()->creatorId())->where('branch_id', 1)->where('department_id',1)->get();
            } */
            $employees = User::paginate(20);



            return view('hrmsystem::attendance.bulk', compact('employees', 'branch', 'department'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    {
        return view('hrmsystem::attendance.import');
    }
    ...
    public function import(Request $request)
    {
        ...
        foreach ($attendance as $key => $employee) {
            if ($key != 0) {
                echo "<pre>";
                if ($employee != null && User::where('email', $employee[0])->exists()) {
                    $email = $employee[0];
                } else {
        ...
        if (!empty($attendanceData)) {
            ...
            foreach ($attendance as $key => $value) {
                if ($key != 0) {
                    $employeeData = User::where('email', $value[0])->first();
                    // $employeeId = 0;
