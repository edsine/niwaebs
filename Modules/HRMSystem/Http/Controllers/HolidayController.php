...
use Modules\HRMSystem\Models\Holiday;
...
class HolidayController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        if(Auth::user()->can('manage holiday'))
        {
            ...
            return view('hrmsystem::holiday.index', compact('holidays'));
        }
        else
        {
    ...
    public function create()
    {
        if(Auth::user()->can('create holiday'))
        {
            ...
            return view('hrmsystem::holiday.create',compact('settings'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function edit(Holiday $holiday)
    {
        ...
        {
            return view('hrmsystem::holiday.edit', compact('holiday'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function calender(Request $request)
    {
        if(Auth::user()->can('manage holiday'))
        {
            ...
            return view('hrmsystem::holiday.calender', compact('arrHolidays','transdate','holidays'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
