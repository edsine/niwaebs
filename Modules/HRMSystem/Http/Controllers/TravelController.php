...
use App\Models\User;
use Modules\HRMSystem\Models\Travel;
...
class TravelController extends AppBaseController
{
    public function index()
    {
        if(Auth::user()->can('manage travel'))
        {
            ...
            return view('hrmsystem::travel.index', compact('travels'));
        }
        else
        {
    ...
    public function create()
    {
        if(Auth::user()->can('create travel'))
        {
            ...
            return view('hrmsystem::travel.create', compact('employees'));
        }
        else
        {
    ...
    public function edit(Travel $travel)
    {
        ...
        if(Auth::user()->can('edit travel'))
        {
            ...
            {
                return view('hrmsystem::travel.edit', compact('travel', 'employees'));
            }
            else
            {
                return response()->json(['error' => __('Permission denied.')], 401);
