...
use Modules\HRMSystem\Models\Award;
...
class AwardController extends AppBaseController
{
    public function index()
    {
        ...
        if($usr->can('manage award'))
        {
            ...
            return view('hrmsystem::award.index', compact('awards', 'employees', 'awardtypes'));
        }
        else
        {
    ...
    public function create()
    {
        if(Auth::user()->can('create award'))
        {
            ...
            return view('hrmsystem::award.create', compact('employees', 'awardtypes'));
        }
        else
        {
    ...
    public function edit(Award $award)
    {
        if(Auth::user()->can('edit award'))
        {
            if($award->created_by == Auth::user()->creatorId())
            {
                ...
                return view('hrmsystem::award.edit', compact('award', 'awardtypes', 'employees'));
            }
            else
            {
                return response()->json(['error' => __('Permission denied.')], 401);
