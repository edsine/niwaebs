...
class LoanOptionController extends AppBaseController
{
    public function index()
    {
        if(Auth::user()->can('manage loan option'))
        {
            ...
            return view('hrmsystem::loanoption.index', compact('loanoptions'));
        }
        else
        {
    ...
    public function create()
    {
        ...
        {
            return view('hrmsystem::loanoption.create');
        }
        else
        {
    ...
    public function edit(LoanOption $loanoption)
    {
        if(Auth::user()->can('edit loan option'))
        {
            if($loanoption->created_by == Auth::user()->creatorId())
            {
                ...
                return view('hrmsystem::loanoption.edit', compact('loanoption'));
            }
            else
            {
                return response()->json(['error' => __('Permission denied.')], 401);
