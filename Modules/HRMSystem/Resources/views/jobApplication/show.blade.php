                        ...
                        <div class="d-flex align-items-center" data-toggle="tooltip" data-placement="right" data-title="2 hrs ago" data-original-title="" title="">
                            <div>
                                @php
                                    ...
                                    $profiles=\Modules\Accounting\Models\Utility::get_file('uploads/job/profile/');
                                @endphp
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-9">
                            @if(!empty($jobApplication->resume))
                                ...
                                <a href="{{asset(Storage::url('uploads/job/resume')).'/'.$jobApplication->resume}}" download="" target="_blank"><i class="fa fa-download text-white"></i></a>
                            </span>
                            @else
                                -
                            @endif
