        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <select name="status" id="" class="form-control select2">
                    ...
                    <option value="Approved" @if($leave->status=='Approved') selected="" @endif>{{__('Approve')}}</option>
                    <option value="Rejected" @if($leave->status=='Rejected') selected="" @endif>{{__('Reject')}}</option>
                </select>
            </div>
        </div>
    </div>
