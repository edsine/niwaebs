            ...
            <div class="card-body table-border-style">
                    <div class="table-responsive">
                        <table class="table mt-3">
                            ...
                            <tr>
                                <td>{{__('Branch')}}</td>
                                <td class="">{{ !empty($job->branches)?$job->branches->branch_name:__('All') }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    @if($job->status=='active')
                                        <span class="p-2 px-3 rounded badge bg-success">{{Modules\HRMSystem\Models\Job::$status[$job->status]}}</span>
                                    @else
                                        <span class="p-2 px-3 rounded badge bg-danger">{{Modules\HRMSystem\Models\Job::$status[$job->status]}}</span>
                                    @endif
                                </td>
                            </tr>
                            <tr>
