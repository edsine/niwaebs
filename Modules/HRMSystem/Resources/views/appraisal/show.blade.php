    ...
    <div class="row py-4">
        <div class="col-md-12">
            <div class="info text-sm">
                ...
                <span>{{ !empty($appraisal->branches) ? $appraisal->branches->branch_name : '' }}</span>
            </div>
        </div>
        <div class="col-md-6 mt-3">
            <div class="info text-sm font-style">
                <strong>{{ __('Employee') }} : </strong>
                <span>{{ !empty($appraisal->employees) ? $appraisal->employees->first_name.' '.$appraisal->employees->last_name : '' }}</span>
            </div>
        </div>
        <div class="col-md-6 mt-3">
            <div class="info text-sm font-style">
