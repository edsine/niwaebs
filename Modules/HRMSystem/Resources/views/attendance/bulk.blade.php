                        ...
                        <table class="table" id="pc-dt-simple">
                            ...
                            @foreach ($employees as $employee)
                                ...
                                <tr>
                                    ...
                                    <td>{{ !empty($employee->branch) ? $employee->branch->name : 'NILL' }}</td>
                                    <td>{{ !empty($employee->department) ? $employee->department->name : 'NILL' }}</td>
                                    <td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="time" class="form-control timepicker"
                                                               name="in-{{ $employee->id }}"
                                                               value="{{ !empty($attendance) && $attendance->clock_in != '00:00:00' ? $attendance->clock_in : \Modules\Accounting\Models\Utility::getValByName('company_start_time') }}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="time" class="form-control timepicker"
                                                               ...
                                                               value="{{ !empty($attendance) && $attendance->clock_out != '00:00:00' ? $attendance->clock_out : \Modules\Accounting\Models\Utility::getValByName('company_end_time') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
