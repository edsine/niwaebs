            ...
            <ul class="list-unstyled mb-0 m-2">
                <li class="dropdown dash-h-item status-drp">
                    ...
                    <div class="dropdown-menu dash-h-dropdown">
                        <a href="{{route('joiningletter.download.pdf',$employee->id)}}" class=" btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks"><i class="fa fa-download ">&nbsp;</i>{{__('PDF')}}</a>

                        <a href="{{route('joininglatter.download.doc',$employee->id)}}" class=" btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks"><i class="fa fa-download ">&nbsp;</i>{{__('DOC')}}</a>
                    </div>
                </li>
            </ul>
            <ul class="list-unstyled mb-0 m-2">
                <li class="dropdown dash-h-item status-drp">
                    ...
                    <div class="dropdown-menu dash-h-dropdown">
                        <a href="{{route('exp.download.pdf',$employee->id)}}" class=" btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks"><i class="fa fa-download ">&nbsp;</i>{{__('PDF')}}</a>

                        <a href="{{route('exp.download.doc',$employee->id)}}" class=" btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks"><i class="fa fa-download ">&nbsp;</i>{{__('DOC')}}</a>
                    </div>
                </li>
            </ul>
            <ul class="list-unstyled mb-0 m-2">
                <li class="dropdown dash-h-item status-drp">
                    ...
                    <div class="dropdown-menu dash-h-dropdown">
                        <a href="{{route('noc.download.pdf',$employee->id)}}" class=" btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks"><i class="fa fa-download ">&nbsp;</i>{{__('PDF')}}</a>

                        <a href="{{route('noc.download.doc',$employee->id)}}" class=" btn-icon dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top"  target="_blanks"><i class="fa fa-download ">&nbsp;</i>{{__('DOC')}}</a>
                    </div>
                </li>
            </ul>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info text-sm font-style">
                                            ...
                                            <span>{{!empty($employee)?$employee->first_name.' '.$employee->last_name:''}}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm font-style">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            ...
                                            <span>{{!empty($employee)?$employee->billing_address:''}}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            ...
                                            <span>{{!empty($employee->branch)?$employee->branch->branch_name:''}}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm font-style">
                                ...
                                <div class="row">
                                    ...
                                    @if(!$documents->isEmpty())
                                        @foreach($documents as $key=>$document)
                                            <div class="col-md-6">
                                                <div class="info text-sm">
                                                    <strong class="font-bold">{{$document->title }} : </strong>
