            ...
            <form>
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <h5 class="emp-title black-text">{{ !empty($payslip->employees)? \Auth::user()->employeeIdFormat( $payslip->employees->id):''}}</h5>
                    </div>
                    <div class="col-md-4 mb-3">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table align-items-center">
                                                        ...
                                                        @foreach($allowances as $allownace)
                                                            @php
                                                                $employess= \App\Models\User::find($allownace->employee_id);
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table align-items-center">
                                                        ...
                                                        @foreach($other_payments as $payment)
                                                            @php
                                                                $employess= \App\Models\User::find($payment->employee_id);
