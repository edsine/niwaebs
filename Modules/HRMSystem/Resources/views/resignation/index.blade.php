                    ...
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            @foreach ($resignations as $resignation)
                                <tr>
                                    @role('super-admin')
                                    <td>{{ !empty($resignation->employee())?$resignation->employee()->first_name.' '.$resignation->employee()->last_name:'' }}</td>
                                    @endrole
                                        ...
                                        <td>
                                            ...
                                            @can('edit resignation')
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#" class="mx-3 btn1 btn-sm align-items-center" data-size="lg" data-url="{{ URL::to('resignation/'.$resignation->id.'/edit') }}" data-ajax-popup="true" data-title="{{__('Edit Resignation')}}" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
                                            ...
                                            @can('delete resignation')
                                                <div class="action-btn bg-danger ms-2">
                                                    ...
                                                    <a href="#" class="mx-3 btn1 btn-sm align-items-center bs-pass-para" data-bs-toggle="tooltip" title="{{__('Delete')}}" data-original-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$resignation->id}}').submit();">
