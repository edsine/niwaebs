                    ...
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            @foreach ($terminations as $termination)
                                <tr>
                                    @role('super-admin')
                                    <td>{{ !empty($termination->employee())?$termination->employee()->first_name.' '.$termination->employee()->last_name:'' }}</td>
                                    @endrole
                                        ...
                                        <td>
                                            ...
                                            @can('edit termination')
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#" class="mx-3 btn1 btn-sm align-items-center" data-url="{{ URL::to('termination/'.$termination->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Termination')}}" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
                                            ...
                                            @can('delete termination')
                                                <div class="action-btn bg-danger ms-2">
                                                    ...
                                                    <a href="#" class="mx-3 btn1 btn-sm align-items-center bs-pass-para" data-bs-toggle="tooltip" title="{{__('Delete')}}" data-original-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$termination->id}}').submit();">
