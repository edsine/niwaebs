                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 mb-0" >
                                    ...
                                    <div class="input-group mb-0" >                       
									<input class="form-control setdate" required="" placeholder="<?php echo trans('lang.checkoutdate');?>" id="checkoutdate" name="checkoutdate" type="date">
                                    {{-- <span class="input-group-addon border-1" id="date" ><i class="fa fa-calendar"></i></span> --}}      
                                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 mb-0" >
                                    ...
                                    <div class="input-group mb-0" >                       
                                    <input class="form-control setdate" required="" placeholder="<?php echo trans('lang.checkindate');?>" id="checkindate" name="checkindate" type="date">
                                    {{-- <span class="input-group-addon border-1" id="date" ><i class="fa fa-calendar"></i></span>  --}}     
                                </div>
