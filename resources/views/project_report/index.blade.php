                                    ...
                                    <div class="col-auto float-end ms-2 mt-4">
                                        ...
                                        <a href="{{ route('project_report.index') }}" class="btn btn-sm btn-danger"
                                            ...
                                            <span class="btn-inner--icon">
                                                ...
                                                {{-- <i
                                                    class="ti ti-trash-off text-white-off"></i> --}}
                                ...
                                @if (isset($projects) && !empty($projects) && count($projects) > 0)
                                    @foreach ($projects as $key => $project)
                                        <tr>
                                            ...
                                            <td>{{ Modules\Accounting\Models\Utility::getDateFormated($project->start_date) }}
                                            </td>
                                            <td>{{ Modules\Accounting\Models\Utility::getDateFormated($project->end_date) }}
                                            </td>
                                            <td class="">
                                        ...
                                        <td class="">
                                            <h6 class="mb-0 text-success">
                                                {{ $project->project_progress()['percentage'] }}</h6>
