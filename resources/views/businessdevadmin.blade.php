...
@section('content')
    ...
    <div class="row g-5 g-xl-8 pt-5 mx-5">
        <center><h4 class="text-success-50 mb-5 pt-5">Business Development :<b style="color: #000"> Overview</b></h4></center>
        @include('clokin')
        <div class="col-xl-4">
        ...
        <div class="col-xl-4">
            ...
            <a href="#" class="card shadow bg-dark hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body text-bg-success">
                    ...
                    <span class="svg-icon svg-icon-dark fw-bolder svg-icon-3x ms-n1">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.3"
                    ...
                    <div class="fw-semibold text-dark fw-bolder">Total Issued Licences</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
        ...
        <div class="col-xl-4">
            ...
            <a href="#" class="card shadow bg-dark hoverable card-xl-stretch mb-xl-8">
                ...
                <div class="card-body bg-light-success">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-white fw-bold fs-2 mb-2 text-dark mt-5">0</div>
                    <div class="fw-semibold text-dark fw-bolder">Total Issued Permits</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
    ...
    <div class="row g-5 g-xl-8 mx-5">
        ...
        <div class="col-xl-6">
            ...
            <div class="card">
                <div class="card-body">
                  <h4 class="card-title">ANNUAL SALES PERFORMANCE</h4>
