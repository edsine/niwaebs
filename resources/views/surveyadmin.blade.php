                    ...
                    <div class="card h-lg-100">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                            ...
                            <div class="d-flex flex-column my-7">
                                ...
                                <!--begin::Follower-->
                                <div class="m-0">
                                    <span class="fw-semibold fs-6 text-gray-400">Number of Operational Permits And
                                        Licenses</span>
                                </div>
                                <!--end::Follower-->
                            </div>
                            ...
                            <span class="badge badge-light-success fs-base">
                                ...
                                <span class="svg-icon svg-icon-5 svg-icon-success ms-n1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-window-stack" viewBox="0 0 16 16">
                                        <path
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-start flex-column">
                            ...
                            <div class="m-0">
                                ...
                                <span class="svg-icon svg-icon-2hx svg-icon-gray-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-envelope-paper-fill" viewBox="0 0 16 16">
                            ...
                            <div class="card-p mt-n20 position-relative">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="#" class="text-dark fw-semibold fs-6">Total Number of Clients:
                                            0</a>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="#" class="text-primary fw-semibold fs-6">Services Registered For :
                                            0</a>
                                    </div>
                                    <!--end::Col-->
                                </div>
                            ...
                            <div class="card-p mt-n20 position-relative">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="#" class="text-primary fw-semibold fs-6">Payment Verification
                                            Status : 0</a>
                                    </div>
                                    <!--end::Col-->
                                </div>
                            ...
                            <div class="card-p mt-n20 position-relative">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-primary px-4 py-8 rounded-2 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="#" class="text-primary fw-semibold fs-6">Breakdown Of Operational
                                            Permits and Lincenses: 0</a>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Row-->
                    ...
                    <div class="card card-flush overflow-hidden h-md-100">
                        ...
                        <div class="card-header py-5">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-gray-400 mt-1 fw-semibold fs-6">Total number of Trained Employees per
                                    Month</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
            ...
            <div class="row mx-7 g-5 g-xl-8">
                ...
                <div class="col-xl-6">
                    ...
                    <div class="shadow card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body p-0">
                            <!--begin::Chart-->
                            <div class="mixed-widget-12-chart card-rounded-bottom bg-dark" data-kt-color="info"
                ...
                <div class="col-xl-6">
                    ...
                    <div class="shadow card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body p-0">
                            <!--begin::Chart-->
                            <div class="mixed-widget-12-chart card-rounded-bottom bg-light-warning"
                                data-kt-color="light-warning" style="height: 250px"></div>
                            <!--end::Chart-->
                            <!--begin::Stats-->
                            <div class="card-rounded bg-body mt-n10 position-relative card-px py-15">
                                <!--begin::Row-->
