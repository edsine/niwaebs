...
@section('content')
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <line x1="8" y1="12" x2="16" y2="12" />
            ...
            <center>
                <h1 class=" mb-5 text-center text-success"> PROJECT DEPARTMENT </h1>
            </center>
                        ...
                        <div class="card-p mt-n20 position-relative">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                    ...
                                    <!--end::Svg Icon-->
                                    <a href="#" class="text-warning fw-bold fs-6">Pending Projects</a>
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                        ...
                        <div class="card-p mt-n20 position-relative">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                    ...
                                    <!--end::Svg Icon-->
                                    <a href="#" class="text-warning fw-bolder">Pending Contract</a>
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                    ...
                                    <!--end::Svg Icon-->
                                    <a href="#" class="text-primary fw-bold fs-6">Approved Contract</a>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
                                    ...
                                    <!--end::Svg Icon-->
                                    <a href="#" class="text-danger fw-bold fs-6 mt-2">Notification</a>
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col bg-light-success px-6 py-8 rounded-2">
                                    ...
                                    <!--end::Svg Icon-->
                                    <a href="#" class="text-success fw-bold fs-6 mt-2">Approved Sites</a>
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Row-->
                    ...
                    <div class="card-body d-flex flex-column p-0">
                        ...
                        <div class="flex-grow-1 card-p pb-0">
                            <div class="d-flex flex-stack flex-wrap">
                                <div class="me-2">
                                    <a href="#" class="text-dark text-hover-primary fw-bolder fs-3">TASK OVERVIEW
                                        s</a>
                ...
                <div class="card card-xl-stretch-50 mb-5 mb-xl-8">
                    ...
                    <div class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
                        ...
                        <div class="d-flex flex-stack flex-wrap flex-grow-1 px-9 pt-9 pb-3">
                            <div class="me-2">
                                <span class="fw-bolder text-gray-800 d-block fs-3">Project status</span>
