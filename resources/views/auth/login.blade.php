...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/media/logos/niwalogo.jpeg') }}" />
                    ...
                    <div class="card-body ">
                        ...
                        <div class="d-flex flex-center flex-column-fluid">
                            ...
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="{{ url('/login') }}" method="post">
                                ...
                                <div class="text-center mb-11">
                                    <!--begin::Title-->
                                    <h5 class="fw-bolder mb-3 fs-3 text" style="text-align:center; font-weight:bold; line-height:1.4;">National Inland WaterWays Authority Enterprise Business Suite (EBS)</h5>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Input group=-->
                                ...
                                <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                    ...
                                    <!--begin::Link-->
                                    <a href="{{ route('password.request') }}" class="text-blue rmbrme-and-fgtpwd">Forgot Password ?</a>
                                    <!--end::Link-->
                                </div>
                                <!--end::Wrapper-->
                                <!--begin::Submit button-->
                                <div class="d-grid mb-5">
                                    <button type="submit" id="kt_sign_in_submit" class="btn btn-lg" style="background: #0d02a1; color: #fff">
