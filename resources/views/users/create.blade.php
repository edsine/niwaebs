        ...
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="example-form" method="post" action="{{route('users.store')}}">
...
<script>
    //  document.getElementById("example-form").addEventListener('click', dosomething);
document.getElementById('example-form').onSubmit(dosomething())
