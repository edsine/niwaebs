        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="text-black-50 pt-5">1. Administration, Corporate Services and Human Resources :<b
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                                    ...
                                    <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                        ...
                                        <div class="mb-4 px-9">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <!--begin::Value-->
                                                <span
                                                    class="fs-2hx fw-bold text-gray-800 me-2 lh-1">{{ $staff_count }}</span>
                                                <!--end::Value-->
                                                <!--begin::Label-->
                        ...
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-header flex-nowrap pt-5">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-gray-400 pt-2 fw-semibold fs-6">Graphical representations of
                                        Industrial Relation and Staff Matters</span>
                                </h3>
                                <!--end::Title-->
                            </div>
                            <!--end::Header-->
                ...
                <div class="row">
                    ...
                    <div id="event-modal" class="modal fade" tabindex="-1" aria-hidden="true" role="dialog"
                        ...
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-gray-400 pt-2 fw-semibold fs-6">Tracking Promotions, New Hires, and
                                        Retirements</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
            ...
            <div class="card-header border-0 pt-5">
              ...
              <!-- Tabs content -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                {{-- <h1>Events</h1> --}}
                                <button id="add-event-button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#event-modal">Add Event</button>
                                <div id="calendar"></div>

                                <!-- Event Modal -->
                                <div id="event-modal" class="modal" tabindex="-1" role="dialog" aria-hidden="true"
                                    data-backdrop="false">
                                            ...
                                            <div class="modal-body">
                                                <form id="event-form" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select multiple class="form-control" id="departments1"
                                                            name="department_ids[]">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select multiple class="form-control" id="rankings1"
                                                            name="ranking_ids[]">
