...
<head>
    <title>{{(\Modules\Accounting\Models\Utility::getValByName('title_text')) ? \Modules\Accounting\Models\Utility::getValByName('title_text') : config('app.name', 'ERPGO')}} - @yield('page-title')</title>
...
{{--    <link rel="icon" href="{{ asset('assets/images/favicon.svg') }}" type="image/x-icon"/>--}}
    ...
    <link rel="stylesheet" href="{{ asset('atp/assets/css/plugins/flatpickr.min.css') }}">

    <link rel="stylesheet" href="{{ asset('atp/assets/css/plugins/animate.min.css') }}">

    <!-- font css -->
    <link rel="stylesheet" href="{{ asset('atp/assets/fonts/tabler-icons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('atp/assets/fonts/feather.css') }}">
    <link rel="stylesheet" href="{{ asset('atp/assets/fonts/fontawesome.css') }}">
    <link rel="stylesheet" href="{{ asset('atp/assets/fonts/material.css') }}">

    <!--bootstrap switch-->
    <link rel="stylesheet" href="{{ asset('atp/assets/css/plugins/bootstrap-switch-button.min.css') }}">

    <!-- vendor css -->
    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ asset('atp/assets/css/style-rtl.css') }}">
    @endif


    @if($setting['cust_darklayout'] == 'on')
        <link rel="stylesheet" href="{{ asset('atp/assets/css/style-dark.css') }}" id="main-style">
    @else
        <link rel="stylesheet" href="{{ asset('atp/assets/css/style.css') }}" id="main-style">
    @endif


    <link rel="stylesheet" href="{{ asset('atp/assets/css/customizer.css') }}">
    <link rel="stylesheet" href="{{ asset('atp/css/custom.css') }}" >

    @if ($setting['cust_darklayout'] == 'on')
        <link rel="stylesheet" href="{{ asset('atp/css/custom-dark.css') }}" >
    @endif
