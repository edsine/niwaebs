    ...
    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
        ...
        <div class="menu-item ">
            <a class="menu-link" href="{{ route('document.index') }}">
                ...
                <span class="menu-title spicyj">Client Documents</span>
        ...
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
            <span class="menu-link">
                ...
                <span class="menu-title spicyj">Services</span>
                <span class="menu-arrow"></span>
            </span>
            <div class="menu-sub menu-sub-accordion menu-active-bg">
                <div class="menu-item">
        ...
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
            <span class="menu-link">
                ...
                <span class="menu-title spicyj">Sub-Services</span>
                <span class="menu-arrow"></span>
            </span>
            <div class="menu-sub menu-sub-accordion menu-active-bg">
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('sub-services.index') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">Lists</span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('sub-services.create') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">Add New</span>
        ...
        <div class="menu-item ">
            <a class="menu-link {{ Request::is('serviceApplications*') ? 'active' : '' }}"
                href="{{ route('serviceApplications.index') }}">
                <span class="menu-icon">
                    <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                    <span class="svg-icon svg-icon-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                <span class="menu-title spicyj">Service Applications</span>
        ...
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
            <span class="menu-link">
                ...
                <span class="menu-title spicyj">Equipment and Fees</span>
                <span class="menu-arrow"></span>
            </span>
            <div class="menu-sub menu-sub-accordion menu-active-bg">
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('equipmentAndFees.index') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">Lists</span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('equipmentAndFees.create') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">Add New</span>
        ...
        @if (auth()->user()->staff->department_id == 6 ||
                auth()->user()->hasRole('super-admin'))
            @include('accounting::layouts.menu')
        @endif
        @include('hrmsystem::layouts.menu')

        @if (auth()->user()->staff->department_id == 5 ||
                auth()->user()->hasRole('super-admin'))
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon">
