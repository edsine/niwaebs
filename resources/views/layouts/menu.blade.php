        ...
        @can('view approval module')
            ...
            <li class="nav-item" id="myTask">
                ...
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('emplist') }}">Applicant Records</a>
                    </li>


                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('payhistoryform') }}">PaymentHistory</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('serviceupload') }}">Service Application</a>
                    </li>
