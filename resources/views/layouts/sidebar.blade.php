<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: {{(auth()->user()->hasRole('minister') || auth()->user()->hasRole( 'permsec')) ? 'true' : 'false'}}}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    ...
    <div class="app-sidebar-logo px-6 my-4" id="kt_app_sidebar_logo">
        ...
        <a style= "padding-left: 60px" href="{{ route('home') }}">
            <img alt="Logo" src="{{asset('assets/media/logos/logo-light.png')}}" class="h-80px app-sidebar-logo-default" />
            <img alt="Logo" src="{{asset('assets/media/logos/logo-light.png')}}" class="h-50px app-sidebar-logo-minimize" />
