                ...
                <form action="#" id="formadd" autocomplete="off">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-0" >
									...
									<input class="form-control setdate" required="" placeholder="<?php echo trans('lang.startdate');?>" id="startdate" name="startdate" type="date">
                        ...
                        <div class="form-group  mb-0" >
                                    ...
                                    <div class="input-group mb-0" >                       
									<input class="form-control setdate" required="" placeholder="<?php echo trans('lang.enddate');?>" id="enddate" name="enddate" type="date">
                                    {{-- <span class="input-group-addon border-1" id="date"><i class="fa fa-calendar"></i></span>  --}}     
                                </div>
                ...
                <form action="#" id="formedit">
                    ...
                    <div class="form-group" >
                        ...
                        <div class="form-group mb-0" >
                                    ...
                                    <div class="input-group mb-0" >                       
									<input class="form-control setdate" required="" placeholder="<?php echo trans('lang.startdate');?>" id="editstartdate" name="startdate" type="date">
                                   {{--  <span class="input-group-addon border-1" id="date" ><i class="fa fa-calendar"></i></span>  --}}     
                                </div>
                        ...
                        <div class="form-group mb-0">
                                    ...
                                    <div class="input-group mb-0" >                       
									<input class="form-control setdate" required="" placeholder="<?php echo trans('lang.enddate');?>" id="editenddate" name="enddate" type="date">
                                    <span class="input-group-addon border-1" id="date" ><i class="fa fa-calendar"></i></span>      
                                </div>
