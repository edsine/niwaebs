<nav class="navbar navbar-default">
    <div class="container-fluid">
      ...
      <div class="navbar-header">
        <a class="navbar-brand" href="{{route('document.create') }}"> </a>
        {{-- <a class="navbar-brand" href="">@if($ldms_general_setting_data->site_logo)<img src="{{url('public/logo', $ldms_general_setting_data->site_logo)}}" style="width: 20px; height: auto; display: inline-block;">@endif {{$ldms_general_setting_data->site_title}}</a> --}}
      </div>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown text-center">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="{{ route('document.create') }}"><i class="fa fa-tachometer"></i> {{trans('file.Dashboard')}}</a></li>
            <li><a href="{{ route('document.updateprofile') }}"><i class="fa fa-support"></i> {{trans('file.User Options')}}</a></li>
            {{-- <?php
            ...
            <li><a href="{{ route('role.create') }}"><i class="fa fa-support"></i> {{trans('file.Create Role')}}</a></li>
            <li><a href="{{ route('user.create') }}"><i class="fa fa-support"></i> {{trans('file.Create User Account')}}</a></li>
        ...
        <li>
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a class="danger" href="{{ route("expireddocument") }}"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> <?php echo count($ldms_expired_documents_all);?> {{trans('file.Documents Expired')}}</a></li>
            <li><a class="warning" href="{{ route("closetobe") }}"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> <?php echo count($ldms_close_expired_documents_all);?> {{trans('file.Documents Expiring Soon')}}</a></li>
          </ul>
        </li>
        <li>
