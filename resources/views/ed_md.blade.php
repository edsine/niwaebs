    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <!--begin::Toolbar-->
                <center>
                    <h3 class="fw-bolder">Funds' Structural Composition
                    </h3>
                </center>
                ...
                <div class="row g-6 g-xl-9">
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body" data-toggle="modal" data-target="#exampleModalCenterxxdigreg">
                                ...
                                <div class="fw-bold " style="color:green"><strong>Digital Registration Centers</strong>
                                </div>
                    ...
                    <center>
                        <h3 class="fw-bolder">Financial Analysis
                        </h3>
                    </center>
                            ...
                            <div class="card  shadow bg-light-primary card-xl-stretch mb-5 mb-xl-8">
                                ...
                                <div class="card-body my-3">
                                    ...
                                    <div class="progress h-7px bg-secondary bg-opacity-50 mt-7">
                                        <div class="progress-bar bg-secondry" role="progressbar" style="width: 76%"
                                            aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <!--end:: Body-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        ...
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 fw-bolder text-hover-primary fs-6">Revenue from
                                                Certificate </a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        ...
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 fw-bolder text-hover-primary fs-6">Staff Emolument</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                            <!-- <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Direct link clicks</span> -->
                                            <!--end::Desc-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        ...
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 fw-bolder text-hover-primary fs-6">Overhead Cost</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                            <!-- <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">All Social Channels</span> -->
                                            <!--end::Desc-->
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        ...
                                        <div class="me-5">
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-gray-800 fw-bolder text-hover-primary fs-6">Capital
                                                Expenditure</a>
                                            <!--end::Title-->
                                            <!--begin::Desc-->
                                            <!-- <span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Mailchimp Campaigns</span> -->
                            ...
                            <div class="card-header flex-nowrap border-0 pt-9">
                                ...
                                <div class="card-title m-0">
                                    ...
                                    <div class="symbol symbol-45px w-45px bg-light me-5">
                                        <img src="assets/media/svg/brand-logos/twitch.svg" alt="image"
                                            class="p-3" />
                                    </div>
                                    <!--end::Icon-->
                                    <!--begin::Title-->
                                    <a href="#" class="fs-4 fw-bold text-hover-primary text-gray-600 m-0">TOTAL NO.
                                        OF FUNDS STAFFS</a>
                                    <!--end::Title-->
                                </div>
                                <!--end::Card title-->
                            ...
                            <div class="card-header flex-nowrap border-0 pt-9">
                                ...
                                <div class="card-toolbar m-0">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                        ...
                                        <!--begin::Heading-->
                                        <div class="menu-item px-3">
                                            <div class="menu-content text-muted pb-2 px-3 fs-7 text-uppercase">MANAGEMENT
                                                STAFF..</div>
                                        </div>
                                        <!--end::Heading-->
                                        <!--begin::Menu item-->
            ...
            <div class="modal fade" id="exampleModalCenterxxd" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <div class="modal fade" id="exampleModalCenterxxdigreg" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <div class="modal fade" id="exampleModalCenterxxrevecs" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <div class="modal fade" id="exampleModalCenterxxrevcerts" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <center>
                                <h4>No Records Available At The Moment🙁...</h4><br><b>Please try again later!</b>
                                <center>
                                    <br>
                                    <hr />
                        </div>
            ...
            <div class="modal fade" id="exampleModalCenterxx" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <div class="modal fade XL" id="exampleModalCenterxxDEP" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Responsible for the recruitment, selection, training, and development of staff.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                    ...
                                    <tr>
                                        <td>9</td>
                                        <td>Compliance</td>
                                        <td>Ensures that the organization complies with all applicable laws and regulations.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>10</td>
                                    ...
                                    <tr>
                                        <td>15</td>
                                        <td>Inspections</td>
                                        <td>Inspects the organization's operations to ensure compliance with laws and
                                            regulations.</td>
                                    </tr>
                                    <tr>
                                        <td>16</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Ensures the health, safety, and environmental compliance of the organization.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>18</td>
            ...
            <div class="modal fade" id="exampleModalCenterxxRO" tabindex="-1" role="dialog"
                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                                        ...
                                        <div class="current" data-kt-stepper-element="content">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <div class="mb-13">
                                                    ...
                                                    <!--end::Title-->
                                                    <!--begin::Description-->
                                                    <div class="text-muted fw-bold fs-5">If you need more info, please
                                                        check out
                                                        ...
                                                        <span class="d-flex">
                                                            ...
                                                            <span class="ms-4">
                                                                <span
                                                                    ...
                                                                    Deal</span>
                                                                <span class="fw-bold fs-4 text-muted">If you need more
                                                        ...
                                                        <span class="d-flex">
                                                            ...
                                                            <span class="ms-4">
                                                                <span
                                                                    ...
                                                                    Deal</span>
                                                                <span class="fw-bold fs-4 text-muted">Create corporate
                                                ...
                                                <div class="fv-row mb-15">
                                                    ...
                                                    <div class="d-flex flex-stack">
                                                        ...
                                                        <div class="me-5">
                                                            ...
                                                            <div class="fs-7 fw-bold text-muted">Allow Notifications by
                                                                Phone or Email</div>
                                                        </div>
                                                        <!--end::Label-->
                                                        <!--begin::Checkboxes-->
