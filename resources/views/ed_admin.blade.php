        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="row g-6 g-xl-9">
                    ...
                    <center>
                        <h3 class="fw-bolder">Human Resources
                        </h3>
                    </center>
                    ...
                    <center>
                        <h3 class="fw-bolder">GENERAL ADMIN
                        </h3>
                    </center>
                                ...
                                <div class="modal-body p-4 py-5 p-md-5">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Lagos Region</td>
                                                <td>APAPA, AGEGE, ISLAND, IKEJA, MAINLAND, OTTA, LEKKI, IKORUDU, SATELLITE
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Ibadan Region</td>
                                    ...
                                    <table class="table table-bordered table-sm">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Oversees the overall administration and operations of the organization.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>Human Resource Management</td>
                                                <td>Responsible for the recruitment, selection, training, and development of
                                                    staff.</td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                            ...
                                            <tr>
                                                <td>9</td>
                                                <td>Compliance</td>
                                                <td>Ensures that the organization complies with all applicable laws and
                                                    regulations.</td>
                                            </tr>
                                            <tr>
                                                <td>10</td>
                                            ...
                                            <tr>
                                                <td>15</td>
                                                <td>Inspections</td>
                                                <td>Inspects the organization's operations to ensure compliance with laws
                                                    and regulations.</td>
                                            </tr>
                                            <tr>
                                                <td>16</td>
                                                <td>Claims and Compensation</td>
                                                <td>Processes claims for benefits and provides compensation to
                                                    beneficiaries.</td>
                                            </tr>
                                            <tr>
                                                <td>17</td>
                                                <td>Health Safety & Environment</td>
                                                <td>Ensures the health, safety, and environmental compliance of the
                                                    organization.</td>
                                            </tr>
                                            <tr>
                                                <td>18</td>
                                            ...
                                            <tr>
                                                <td>19</td>
                                                <td>General</td>
                                                <td>Handles other matters that do not fall under any specific department.
                                                </td>
                                            <tr>
                                                <td>20</td>
                                                                ...
                                                                <span class="d-flex">
                                                                    ...
                                                                    <span class="ms-4">
                                                                        <span
                                                                            ...
                                                                            Deal</span>
                                                                        <span class="fw-bold fs-4 text-muted">If you need
                                                                            more info, please check it out</span>
                                                                    </span>
                                                                    <!--end::Info-->
                                                                </span>
                                                                <!--end::Label-->
                                                        ...
                                                        <div class="fv-row mb-8">
                                                            ...
                                                            <div class="position-relative w-lg-250px"
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    name="finance_setup" readonly="readonly"
                                                                    value="$50" />
                                                                <!--end::Input control-->
                                                                    ...
                                                                    <label
                                                                        ...
                                                                        <span class="ms-5">
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                money to your bank account per transaction
                                                                                under $50,000 budget</span>
                                                                        </span>
                                                                        <!--end::Info-->
                                                                    </label>
                                                                    <!--end::Option-->
