...
<div class="container">
    ...
    <div class="float-end">
        <a href="#" data-toggle="modal" data-target="#client" class="btn btn-primary"><i class="fa fa-plus"></i>
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <span style="font-weight: 850;">REGISTER NEW CLIENT</span>
                ...
                <div class="modal-body">
                    ...
                    @csrf
                    <form method="post" action="{{ route('clients.store') }}" files="true"
                        enctype="multipart/form-data">
                        <div class="col-md-12">
                            {!! csrf_field() !!}
                            <div class="form-group">
                                <label for="ldms_documentTitle">{{ trans('Name') }}</label>
                                <div class="form-group-inner">
                                    <div class="field-outer">
                                        <input class="form-control" type="text" name="name"
                                            id="ldms_documentTitle" placeholder="{{ trans('Client Name') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="ldms_documentTitle">{{ trans('Email Address') }}</label>
                                <div class="form-group-inner">
                                    <div class="field-outer">
                                        <input class="form-control" type="email" name="email"
                                            id="ldms_documentvendor" placeholder="{{ trans('@email.com') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="ldms_documentTitle">{{ trans('PASSWORD') }}</label>
                                <div class="form-group-inner">
                                    <div class="field-outer">
