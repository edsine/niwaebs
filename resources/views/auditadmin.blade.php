						...
						<div class="card-body d-flex justify-content-between align-items-start flex-column">
							...
							<div class="m-0">
								...
								<span class="svg-icon svg-icon-2hx svg-icon-gray-600 ">
									<svg  width="24" height="24" viewBox="0 0 24 24" class="text-success" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="card bg-light-danger h-lg-100">
						...
						<div class="card-body d-flex justify-content-between align-items-start flex-column">
							...
							<div class="m-0">
								...
								<span class="svg-icon svg-icon-2hx svg-icon-gray-600">
									<svg width="24" height="24" viewBox="0 0 24 24" class="text-success" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="card text-bg-info h-lg-100">
						...
						<div class="card-body d-flex justify-content-between align-items-start flex-column">
							...
							<div class="m-0">
								...
								<span class="svg-icon svg-icon-2hx svg-icon-gray-600">
									<svg width="24" height="24" viewBox="0 0 24 24" class="text-white" fill="none" xmlns="http://www.w3.org/2000/svg">
