    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    {{-- <h4 class="text-black-50 pt-5"> Audit and Internal Control:<b style="color: #000">Overview</b></h4> --}}
                    <!--end::Title-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class=" mx-9">
                <center>
                    <h1 class=" mb-7 text-center text-uppercase text-primary pt-5"> Audit and Internal Control:<b
                        ...
                        <div class="card card-flush h-100 mb-5 mb-xl-10">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-dark">Percentage Expense Distribution
                                        Categories</span>
                                    <span class="text-black pt-2 fw-semibold fs-6">the percentage distribution of expenses
                                        across different categories</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="d-flex align-items-center me-5">
                                                    ...
                                                    <div class="me-5">
                                                        <!--begin::Title-->
                                                        <a href="#"
                                                            class="text-gray-800 fw-bold text-hover-primary fs-6">Permits</a>
                                                        <!--end::Title-->
                                                        <!--begin::Desc-->
                                                        <span
                                                            class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Revenue
                                                            Generated From Permits</span>
                                                        <!--end::Desc-->
                                                    </div>
                                                    <!--end::Content-->
                                                </div>
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="d-flex align-items-center me-5">
                                                    ...
                                                    <div class="me-5">
                                                        <!--begin::Title-->
                                                        <a href="#"
                                                            class="text-gray-800 fw-bold text-hover-primary fs-6">Licences</a>
                                                        <!--end::Title-->
                                                        <!--begin::Desc-->
                                                        <span
                                                            class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Revenue
                                                            Generated From Licences</span>
                                                        <!--end::Desc-->
                                                    </div>
                                                    <!--end::Content-->
                                                </div>
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="d-flex align-items-center me-5">
                                                    ...
                                                    <div class="me-5">
                                                        <!--begin::Title-->
                                                        <a href="#"
                                                            class="text-gray-800 fw-bold text-hover-primary fs-6">Certificates</a>
                                                        <!--end::Title-->
                                                        <!--begin::Desc-->
                                                        <span
                                                            class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Revenue
                                                            Generated From Certificates</span>
                                                        <!--end::Desc-->
                                                    </div>
                                                    <!--end::Content-->
                                                </div>
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="d-flex align-items-center me-5">
                                                    ...
                                                    <div class="me-5">
                                                        <!--begin::Title-->
                                                        <a href="#"
                                                            class="text-gray-800 fw-bold text-hover-primary fs-6">Form
                                                            Application</a>
                                                        <!--end::Title-->
                                                        <!--begin::Desc-->
                                                        <span
                                                            class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Revenue
                                                            Generated From Form Application</span>
                                                        <!--end::Desc-->
                                                    </div>
                                                    <!--end::Content-->
                                                </div>
                    ...
                    <div class="col-xl-7 mb-5 mb-xl-10">
                        ...
                        <div class="card card-flush h-xl-50 mb-xl-10">
                            ...
                            <div class="card-header pt-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Monetary Expense Distribution
                                        Categories</span>
                                ...
                                <div class="card-header py-5">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left"
                                            ...
                                            <span class="svg-icon svg-icon-1 ms-2 me-0">
                                                <svg width="24" height="24" viewBox="0 0 24 24"
                                                    class="text-white" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path opacity="0.3"
                                                        d="M21 22H3C2.4 22 2 21.6 2 21V5C2 4.4 2.4 4 3 4H21C21.6 4 22 4.4 22 5V21C22 21.6 21.6 22 21 22Z"
                                                        fill="currentColor" />
                                                    <path
                                ...
                                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <span class="svg-icon svg-icon-2hx svg-icon-gray-600 ">
                                            <svg width="24" height="24" viewBox="0 0 24 24" class="text-success"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.3"
                            ...
                            <div class="card bg-light-primary h-lg-100">
                                ...
                                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                    ...
                                    <div class="d-flex flex-column my-7">
                                        ...
                                        <!--begin::Follower-->
                                        <div class="m-0">
                                            <span class="fw-bold fs-6 text-black">Pending Transactions</span>
                                        </div>
                                        <!--end::Follower-->
                                    </div>
                                    <!--end::Section-->
