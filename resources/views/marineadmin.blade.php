...
@section('content')
    <div class="container-fluid">
        ...
        <!--begin::Row-->
        <center>
            <h1 class="text-black-50  text-center pt-5">MARINE DEPARTMENT: <b style="color: #000">Overview</b></h1>
        </center>
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card shadow card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">TOTAL NUMBER OF ISSUED
                                        CERTIFICATES</h5>
        ...
        <script>
            ...
            var barColors = ["red", "green", "blue", "orange", "brown", "goldenrod", "purple", "brown", "goldenrod",
            "purple", ];
