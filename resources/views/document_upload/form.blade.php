                    ...
                    <div class="form-control-wrap">
                        ...
                        <select class="form-control" name="service_id">
                            @foreach($services as $service)
                                <option value="{{ $service->id }}" {{ old('service_id', isset($document_upload) && $document_upload->service_id == $service->id ? 'selected' : '') }}>
                                    {{ $service->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-control-wrap">
                    ...
                    <select class="form-control" name="branch_id">
                        @foreach($branches as $branch)
                            <option value="{{ $branch->id }}" {{ old('branch_id', isset($document_upload) && $document_upload->branch_id == $branch->id ? 'selected' : '') }}>
                                {{ $branch->branch_name }}
                            </option>
                        @endforeach
                    </select>
