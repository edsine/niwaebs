...
class Component extends Controller
{
    ...
    public function historycomponentbyid( Request $request ) {
      ...
      $data = DB::select("select component_assets.*, niwa_assets.name as assetname 
        from component_assets left join niwa_assets  
        on component_assets.assetid = niwa_assets.id
